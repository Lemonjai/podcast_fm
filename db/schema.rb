...
ActiveRecord::Schema.define(version: 20160713033021) do
  ...
  create_table "podcasts", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_podcasts_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_podcasts_on_reset_password_token", unique: true, using: :btree
  end
